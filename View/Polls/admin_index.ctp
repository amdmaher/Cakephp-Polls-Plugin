...
<?php
		...
		echo	$this->Html->link(__('Add'), array('action' => 'add'), array('class' => 'add'));
			
		echo	$this->Html->link(__('List Options'), array('controller' => 'poll_options', 'action' => 'index'), array('class' => 'index'));
		echo	$this->Html->link(__('New Option'), array('controller' => 'poll_options', 'action' => 'add'), array('class' => 'add'));
		echo	$this->Html->link(__('List Votes'), array('controller' => 'poll_votes', 'action' => 'index'), array('class' => 'index'));
		 ?>
